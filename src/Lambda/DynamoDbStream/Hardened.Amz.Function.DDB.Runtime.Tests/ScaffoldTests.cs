...
namespace Hardened.Amz.Function.DDB.Runtime.Tests;

/// <summary>
/// Scaffolding, created 2026-08-11 as part of Phase 0 of TESTING-PLAN.md.
///
/// <para>
/// This project exists so the <c>aws-batch</c> workstream can add test files without editing the
...
public class ScaffoldTests {
    ...
    public void TheAssemblyUnderTestIsReferencedAndLoadable() {
        var assembly = Assembly.Load("Hardened.Amz.Function.DDB.Runtime");
